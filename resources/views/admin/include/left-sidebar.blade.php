<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseGroupMember" class="collapse" aria-labelledby="headingGroupMember" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Components:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="collapseServiceHistory" class="collapse" aria-labelledby="headingServiceHistory" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Components:</h6>
    ...
    {{-- <div class="sidebar-card d-none d-lg-flex">
        <img class="sidebar-card-illustration mb-2" src="{{ asset('adminAsset') }}/img/undraw_rocket.svg" alt="...">
